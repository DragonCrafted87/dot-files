...
install_build_deps() {
    ...
    # Fedora discussion #284 plus current hypr* / Qt6 / portal needs.
    # Each group is tried left-to-right for OpenMandriva vs Fedora names.
    local groups=(
        "clang"
        "llvm"
        "lld"
        ...
        "mesa-libEGL-devel lib64mesaegl-devel lib64EGL-devel libglvnd-devel"
        "mesa-libgbm-devel lib64mesagbm-devel libgbm-devel"
        "mesa-libGLES-devel lib64mesagles-devel libGLES-devel"
        "mesa-libGL-devel lib64mesagl-devel"
        "cairo-devel lib64cairo-devel"
        "pango-devel lib64pango-devel"
        "pixman-devel lib64pixman-devel lib64pixman1-devel"
        "libxcb-devel lib64xcb-devel"
        "xcb-proto xcb-proto-devel"
        "xcb-util-devel lib64xcb-util-devel"
        "xcb-util-wm-devel lib64xcb-util-wm-devel"
        "xcb-util-image-devel lib64xcb-util-image-devel"
        "xcb-util-keysyms-devel lib64xcb-util-keysyms-devel"
        "xcb-util-renderutil-devel lib64xcb-util-renderutil-devel"
        "xcb-util-errors-devel lib64xcb-util-errors-devel libxcb-errors-devel"
        "libX11-devel lib64X11-devel"
        "libXcursor-devel lib64Xcursor-devel"
        "libXcomposite-devel lib64Xcomposite-devel"
        "libXrender-devel lib64Xrender-devel"
        "libXfixes-devel lib64Xfixes-devel"
        ...
        "sdbus-c++-devel sdbus-cpp-devel libsdbus-c++-devel"
        "polkit-devel lib64polkit-devel polkit"
        "pipewire-devel lib64pipewire-devel"
        "libei-devel lib64ei-devel libei"
        "lua-devel lib64lua-devel lua5.5-devel lua"
        "qt6-qtbase-devel lib64qt6core-devel qt6-base-devel"
        "qt6-qtdeclarative-devel qt6-qtqml-devel lib64qt6qml-devel"
        "qt6-qtwayland-devel lib64qt6wayland-devel"
        "qt6-qttools-devel"
...
install_session_files() {
    ...
    # Distinct filename so the distro hyprland.desktop is untouched.
    sudo install -m 0644 "$SESSION_DESKTOP_SRC" \
...
configure_ly_source_session() {
    # Keep the official OpenMandriva session as the default. Only expose
    # the prefix build as an extra Ly entry.
